...
{!! Form::open(['method' => 'POST', 'route' => 'updatecontact']) !!}
@method('PUT')
      <div class="flex flex-col md:flex-row">
       ...
       @enderror
        ...
        <div class="w-full mx-2 flex-1 svelte-1l8159u">
            ...
            <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                {{ Form::text('permanentProvince', '', [old('permanentCheck') == '1' ? 'readonly' : '', 'placeholder' => 'Province', 'class' => old('permanentCheck') == '1' ? 'fordisable p-1 sm:text-sm text-xs  px-2 appearance-none outline-none w-full text-gray-800 bg-gray-200' : 'fordisable sm:text-sm text-xs p-1 px-2 appearance-none outline-none w-full text-gray-800']) }}
            </div>
