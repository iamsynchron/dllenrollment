  ...
  {!! Html::decode(Form::label('noteLabel', 'Please read first <span class="text-red-600"> *</span>', ['class' => 'font-bold text-gray-600 text-xs leading-8 uppercase h-6 mx-2 mt-3'])) !!}
            ...
            <div class="p-4 border-b">
                <div class="py-2 px-2 flex justify-between">
                  ...
                  {{ Form::submit('Generate Report', [ 'wire:click' => 'submit', 'class' => 'sm:text-sm text-xs bg-green-600 text-white flex justify-center mx-2 px-4 py-2 rounded font-bold cursor-pointer']) }} 
