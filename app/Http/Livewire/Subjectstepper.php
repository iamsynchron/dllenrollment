...
class Subjectstepper extends Component
{   
   ...
   use WithPagination;
    ...
    public $pages = [
        1 => [
            'heading' => 'Course and Section',
            'subheading' => 'Enroll your Course and Section'
        ],
        2 => [
            'heading' => 'Subjects',
            'subheading' => 'Enroll your Subjects'
        ]
    ];
                ...
                if($this->studtypemodel == '1'){
                    $this->validate([
                      ...
                      DB::transaction(function(){
                        //Section Initialize
                        $savesection = new StudentCourse([
                            'user_id' => auth()->user()->id,
                            'section_id' => $this->sectionmodel,
                            'studtype' => 'reg'
                        ]);
                        ...
                        $updatestatus = FormsStatus::where('user_id', auth()->user()->id)->first();

                        $updatestatus->section = 1;

                        $updatestatus->update();
                        

                        session()->flash('message', 'Subject and Course enrolled successfully');
