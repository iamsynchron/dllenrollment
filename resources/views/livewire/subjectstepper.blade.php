  ...
  {!! Html::decode(Form::label('noteLabel', 'Please read first <span class="text-red-600"> *</span>', ['class' => 'font-bold text-gray-600 text-xs leading-8 uppercase h-6 mx-2 mt-3'])) !!}
              ...
              <div class="flex flex-col md:flex-row">
                  <div class="w-full flex-1 mx-2 svelte-1l8159u">
                    <p class="sm:text-base text-sm text-grey-darkest mb-6 leading-tight">1. <span class="text-red-800 font-bold underline">Shifting to another Course?</span> - Please coordinate first to your respective Program Head and to the Registrar before enrolling your desired course.</p>     
                    <p class="sm:text-base text-sm text-grey-darkest mb-6 leading-tight">2. <span class="text-red-800 font-bold underline">Irregular Student/Transferee?</span> - If you&apos;re an Irregular Student or a Transferee, go to the Registrar&apos;s Office for your subject evaluation before choosing your year&sol;section and enrolling your subjects.</p>  
                    <p class="sm:text-base text-sm text-grey-darkest mb-6 leading-tight">3. <span class="text-red-800 font-bold underline">Regular Student?</span> - Just select your course and year&sol;section.</p>                 
                  </div>
              </div>
              ...
              <div class="flex flex-col mt-3 md:flex-row">         
                <div class="w-full flex-1 mx-2 svelte-1l8159u">
                  <p class="sm:text-base text-xs px-2 text-gray-800 text-md">My Course&sol;Section: 
                    <span class="px-2 text-right font-semibold text-gray-800 sm:text-lg text-s">
                ...
                <div class="flex items-center justify-center">
                    <div class="container">                
                        ...
                        {{ $fordisplay->links() }}
                          @if(($studtypemodel == '1'))
                          <p class="px-5 mt-5 font-bold text-gray-800 sm:text-lg text-s">Total Units: {{$units}}</p>
                          @endif
                          @if(($studtypemodel == '2'))
