...
{!! Form::open(['method' => 'POST', 'route' => 'updatepersonal' ]) !!}
      @method('PUT')

{!! Html::decode(Form::label('fullName', 'Fullname <span class="text-red-600"> *</span>', ['class' => 'font-bold text-gray-600 sm:text-sm text-xs leading-8 uppercase h-6 mx-2 mt-3'])) !!}
