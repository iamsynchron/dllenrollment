...
{!! Form::open(['method' => 'POST', 'route' => 'updateadditional']) !!}
@method('PUT')
...
<p class="sm:text-sm text-xs mb-5 text-center text-gray-500">
    Every Dalubcenian is insured. Please tell us the details of your chosen beneficiary.
</p>
...
<div x-data
        ...
        <div class="w-full flex-1 mx-2 svelte-1l8159u">
            <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u @error('insuranceLastName') border-red-500 @enderror">
                {{ Form::text('insuranceLastName', '', [old('insuranceRadio') == '1' ? 'readonly' : '', 'placeholder' => 'Beneficiary Lastname', 'class' => old('insuranceRadio') == '1' ? 'beneficiary sm:text-sm text-xs p-1 px-2 appearance-none outline-none w-full text-gray-800 bg-gray-200' : 'beneficiary sm:text-sm text-xs -1 px-2 appearance-none outline-none w-full text-gray-800']) }}
                </div>
